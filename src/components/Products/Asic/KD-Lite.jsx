...
const KDLiteDetails = ({ products, onAddToCart }) => {  
  ...
  const handleAddToCart = () => onAddToCart(products[7].id, product);
  const cardStyle = {
    display: "block",
  ...
  <img src='../images/productimgs/KDLITE.png'/>
  </div>
  <div class="bbox price-box">
  <Typography style={{fontSize:32}} variant="h4" gutterBottom component="div">KD Lite Pro</Typography>
  <Typography  style={{fontSize:28}} variant="h4" gutterBottom component="div">16.2TH/s Kadena miner</Typography>
  <Typography style={{fontSize:21}} variant="h4" gutterBottom component="div">Goldshell</Typography>
    <Divider/>
  <Typography style={{fontSize:25}} variant="h4" gutterBottom component="div">Price: $8,799.00</Typography>
