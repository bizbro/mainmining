...
const KDMaxDetails = ({ products, onAddToCart }) => {  
  ...
  <img src='../images/productimgs/KDMax.png'/>
  </div>
  <div class="bbox price-box">
  <Typography style={{fontSize:32}} variant="h4" gutterBottom component="div">KD Max</Typography>
  <Typography  style={{fontSize:28}} variant="h4" gutterBottom component="div">40.2TH/s Kadena miner</Typography>
  <Typography style={{fontSize:21}} variant="h4" gutterBottom component="div">Goldshell</Typography>
    <Divider/>
  <Typography style={{fontSize:25}} variant="h4" gutterBottom component="div">Price: $13,999.00</Typography>
